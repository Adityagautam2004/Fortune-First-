...
const { getAssignedClients, addInvestment , processPayout, getChatHistory, getBoardDashboardStats, voidPayout, getClientActiveInvestments } = require('../controllers/board.controller');
