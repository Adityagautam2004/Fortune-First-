    ...
    <div className="flex flex-col gap-3 rounded-2xl border border-primary/15 bg-muted p-5 sm:flex-row sm:items-center">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full rounded-lg border border-brand-border bg-white py-2.5 pl-9 pr-3 text-sm text-gray-700 placeholder-gray-400 focus:border-primary focus:outline-none"
        />
      </div>
      <button
        onClick={onReset}
