  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-brand-border bg-card px-4 py-4 md:gap-4 md:px-6">
      <div className="flex flex-1 items-center gap-3">
        <button
          onClick={onOpenMenu}
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-muted hover:text-primary md:hidden"
        ...
        <div className="relative w-full max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-full border border-brand-border bg-background py-2.5 pl-10 pr-4 text-sm text-foreground placeholder-muted-foreground transition-colors focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
        </div>
      </div>
